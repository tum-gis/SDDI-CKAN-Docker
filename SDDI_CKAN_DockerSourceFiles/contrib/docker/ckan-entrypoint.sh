...
echo "ckan db is initialized."

#ckan-paster --plugin=ckanext-spatial spatial initdb 4326 -c "${CKAN_CONFIG}/production.ini"
#echo "ckanext-spatial SRID is initialized to 4326."
