...
7. Um den Email-Support zu aktivieren, öffnen Sie die Datei *SDDI-CKAN-Docker source files/production.ini* und tragen Sie ab Zeile 207 die entsprechenden Werte ein (siehe [CKAN Dokumentation](https://docs.ckan.org/en/2.9/maintaining/configuration.html#email-settings)).
8. Öffnen Sie die Datei *SDDI-CKAN-Docker source files/production.ini* und tragen Sie in Zeile 114 einen Admin-Benutzernamen ein (Nur Kleinbuchstaben und -_). Merken Sie sich diesen Benutzernamen für Schritt 11.
